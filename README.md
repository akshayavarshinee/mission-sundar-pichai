...
> Built with **Gemini 2.5 Pro** + **Google Cloud Agent Builder**, with **Arize Phoenix** (via MCP) as the trust layer that must approve every fix before any real-money action.
